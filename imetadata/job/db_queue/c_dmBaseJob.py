...
class CDMBaseJob(CDBBusJob):
    ...
    def classified(self, target: str, target_type: str, target_id: str) -> CPlugins:
        ...
        plugins_file_list = CFile.search_file_or_subpath_of_path(path, 'plugins_*.py')
        for file_name_with_path in plugins_file_list:
            ...
            if object_confirm != CResource.Object_Confirm_IUnKnown:
                CLogger().debug('{0} is classified as {1}.{2}'.format(target, class_classified_obj.get_group_name(),
