...
# @Author : 赵宇飞
# @File : plugins_1011_dem_10_dem.py
...
class plugins_1011_dem_10_dem(CFilePlugins_GUOTU_DEM):
...
if __name__ == '__main__':
    ...
    file_info = CFileInfoEx(plugins_1011_dem_10_dem.FileType_File,
    ...
    plugins = plugins_1011_dem_10_dem(file_info)
    object_confirm, object_name = plugins.classified()
    if object_confirm == plugins_1011_dem_10_dem.Object_Confirm_IUnKnown:
        print('对不起, 您给你的文件, 我不认识')
    elif object_confirm == plugins_1011_dem_10_dem.Object_Confirm_IKnown_Not:
        print('您给你的文件, 我确认它不是对象')
    elif object_confirm == plugins_1011_dem_10_dem.Object_Confirm_IKnown:
        print('您给你的文件, 我确认它的类型是[{0}], 对象名称为[{1}]'.format(plugins.get_id(), object_name))
    elif object_confirm == plugins_1011_dem_10_dem.Object_Confirm_Maybe:
        print('您给你的文件, 我确认它的类型是[{0}], 对象名称为[{1}]'.format(plugins.get_id(), object_name))