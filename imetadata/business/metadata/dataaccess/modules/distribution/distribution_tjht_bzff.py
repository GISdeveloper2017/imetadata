...
class distribution_tjht_bzff(distribution_guotu_object):
    """
    邢凯凯 数据检索分发模块对天津海图标准分幅影像类型数据
    """

    def information(self) -> dict:
        info = super().information()
        info[self.Name_Title] = '天津测绘标准分幅影像'
        # 表名待修改
        info['table_name'] = ''
        return info
    ...
    def access_check_dict(self) -> dict:  # 预留的方法，sync写完后再调
        ...
        check_dict['GeographicName'] = 'GeographicName'
