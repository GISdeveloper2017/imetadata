...
class distribution_object_dem(distribution_guotu_object):
    ...
    def get_sync_mdb_dict_list(self, insert_or_updata) -> list:
        ...
        self.add_value_to_sync_dict_list(
            ...
            metadataxml_bus_xml.get_element_text_by_xpath_one("//item[@name='sjscdwm']"), self.DB_True)
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'submitorganize',
            metadataxml_bus_xml.get_element_text_by_xpath_one("//item[@name='sjbqdwm']"), self.DB_True)
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'copyrightorgnize',
            metadataxml_bus_xml.get_element_text_by_xpath_one("//item[@name='sjcbdwm']"), self.DB_True)
    ...
    def get_sync_xls_dict_list(self, insert_or_updata) -> list:
        ...
        self.add_value_to_sync_dict_list(
            ...
            metadataxml_bus_xml.get_element_text_by_xpath_one("//item[@name='主要数据源']"), self.DB_True)
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'dsometadatajson', self._dataset.value_by_name(0, 'dsometadataxml_bus', ''), self.DB_True)
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'createrorganize',
        ...
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'copyrightorgnize',
            metadataxml_bus_xml.get_element_text_by_xpath_one("//item[@name='产品出版单位名称']"), self.DB_True)
        # sync_dict['supplyorganize']  # 为空
        self.add_value_to_sync_dict_list(
