...
class distribution_guotu_object(distribution_guotu):
    ...
    def get_sync_predefined_dict_list(self, insert_or_updata) -> list:
        ...
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'producetime', CUtils.to_day_format(dso_time_json.xpath_one('time', '') ,dso_time_json.xpath_one('time', '')), self.DB_True)
        ...
        self.add_value_to_sync_dict_list(
            sync_dict_list, 'imagedatetag', CUtils.to_day_format(dso_time_json.xpath_one('time', ''), dso_time_json.xpath_one('time', '')), self.DB_True)
