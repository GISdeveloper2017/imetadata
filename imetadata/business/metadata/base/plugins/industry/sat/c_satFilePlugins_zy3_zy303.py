...
class CSatFilePlugins_zy3_zy303(CSatFilePlugins_zy3):
    ...
    def get_classified_character_of_sat(self, sat_file_status):
        ...
        if (sat_file_status == self.Sat_Object_Status_Zip) or (sat_file_status == self.Sat_Object_Status_Dir):
            return r'(?i)^ZY303.TMS.*', self.TextMatchType_Regex
        else:
            return r'(?i)^ZY303.TMS.*[.]tiff$', self.TextMatchType_Regex
    ...
    def get_metadata_bus_filename_by_file(self) -> str:
        ...
        return CFile.join_file(
            ...
            self.get_fuzzy_metadata_file('ZY303.TMS.*-NAD.xml', '{0}-NAD.xml'.format(self.classified_object_name())
                                         )
        )
    ...
    def init_qa_file_list(self, parser: CMetaDataParser) -> list:
        return [
            {
                self.Name_FileName: self.get_fuzzy_metadata_file(r'(?i)^ZY303.TMS.*[.]tiff$',
