...
class CSatFilePlugins_gf2(COpticalSatPlugins):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'GF2'
        information[self.Plugins_Info_Type_Title] = '高分二号'
        information[self.Plugins_Info_Group] = 'GF2'
        information[self.Plugins_Info_Group_Title] = '高分二号'
