...
class CSatFilePlugins_hy1(COpticalSatPlugins):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'HY1'
        information[self.Plugins_Info_Type_Title] = '海洋一号'
        information[self.Plugins_Info_Group] = 'HY1'
        information[self.Plugins_Info_Group_Title] = '海洋一号'
        information[self.Plugins_Info_CopyRight] = '国家海洋局'
        return information
    ...
    def get_metadata_bus_filename_by_file(self) -> str:
        ...
        return CFile.join_file(
            ...
            self.get_fuzzy_metadata_file('H1C_OPER_.*.meta.(xml|XML)',
        ...
        return [
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file('H1C_OPER_.*\d{2,6}.jpg',
                                                                 '{0}.jpg'.format(
            ...
            },
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file('H1C_OPER_.*_thumb.jpg',
                                                                 '{0}_thumb.jpg'.format(
                                                                     self.file_info.file_main_name))
            }
        ]
    ...
    def get_metadata_bus_configuration_list(self) -> list:
        ...
        return [
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/TopLeft/Latitude'
            },
            {
                self.Name_ID: 'topleftlongitude',  # 左上角经度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/TopLeft/Longitude'
            },
            {
                self.Name_ID: 'toprightlatitude',  # 右上角维度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/TopRight/Latitude'
            },
            {
                self.Name_ID: 'toprightlongitude',  # 右上角经度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/TopRight/Longitude'
            },
            {
                self.Name_ID: 'bottomrightlatitude',  # 右下角维度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/BottomRight/Latitude'
            },
            {
                self.Name_ID: 'bottomrightlongitude',  # 右下角经度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/BottomRight/Longitude'
            },
            {
                self.Name_ID: 'bottomleftlatitude',  # 左下角维度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/BottomLeft/Latitude'
            },
            {
                self.Name_ID: 'bottomleftlongitude',  # 左下角经度 必填
                self.Name_XPath: '/ProductMetaData/ImageInfo/Corners/BottomLeft/Longitude'
            },
            {
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMetaData/ProductInfo/ProduceTime'
            },
            {
                self.Name_ID: 'resolution',  # 分辨率(米) 对应卫星的默认值，从info里取
                self.Name_XPath: '/ProductMetaData/ProductInfo/SpatialResolution'
            },
            {
                self.Name_ID: 'rollangle',  # 侧摆角
                self.Name_XPath: '/ProductMetaData/SatelliteInfo/SatOffNadir'
            },
            {
                self.Name_ID: 'cloudpercent',  # 云量
                self.Name_XPath: '/ProductMetaData/QualityInfo/CloudPercent'
            },
            {
                self.Name_ID: 'dataum',  # 坐标系 默认为null
                self.Name_XPath: '/ProductMetaData/CorrectionParams/ProjectType'
            },
            {
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMetaData/ProductInfo/ProductLevel'
            },
            {
    ...
    def parser_metadata_time_list(self, parser: CMetaDataParser) -> list:
        ...
        return [
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMetaData/ImageInfo/StartTime',
                self.Name_Format: self.MetaDataFormat_XML
            },
            {
                self.Name_ID: self.Name_End_Time,
                self.Name_XPath: '/ProductMetaData/ImageInfo/EndTime',
                self.Name_Format: self.MetaDataFormat_XML
            }
        ]
