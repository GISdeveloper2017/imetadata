...
class CSatFilePlugins_zy02c(COpticalSatPlugins):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'ZY02C'
        information[self.Plugins_Info_Type_Title] = '资源三号02星'
        information[self.Plugins_Info_Group] = 'ZY02C'
        information[self.Plugins_Info_Group_Title] = '资源三号02星'
