...
class CSatFilePlugins_zy3(COpticalSatPlugins):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'ZY3'
        information[self.Plugins_Info_Type_Title] = '资源一号01/02星'
        information[self.Plugins_Info_Group] = 'ZY3'
        information[self.Plugins_Info_Group_Title] = '资源一号'
