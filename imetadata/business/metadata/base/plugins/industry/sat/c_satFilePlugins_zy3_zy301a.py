...
class CSatFilePlugins_zy3_zy301a(CSatFilePlugins_zy3):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'ZY3_BWD'
        information[self.Plugins_Info_Type_Title] = '资源一号01星BWD传感器'
        return information
    ...
    def get_classified_character_of_sat(self, sat_file_status):
        ...
        if (sat_file_status == self.Sat_Object_Status_Zip) or (sat_file_status == self.Sat_Object_Status_Dir):
            return r'(?i)^zy30(1|2)a.*_.*', self.TextMatchType_Regex
        else:
            return r'(?i)^zy30(1|2)a.*_.*[.]tiff$', self.TextMatchType_Regex
    ...
    def get_metadata_bus_filename_by_file(self) -> str:
        ...
        return CFile.join_file(
            ...
            self.get_fuzzy_metadata_file('(?!.*Check|.*rad).*.xml', '{0}.xml'.format(self.classified_object_name())
                                         )
        )
    ...
    def init_qa_file_list(self, parser: CMetaDataParser) -> list:
        return [
            {
                self.Name_FileName: self.get_fuzzy_metadata_file(r'(?i)^zy30(1|2)a.*_.*[.]tiff$',
        ...
        return [
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file('.*zy30(1|2)a_.*_pre.jpg',
                                                                 '{0}_pre.jpg'.format(
            ...
            },
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file('.*zy30(1|2)a_.*_ico.jpg',
                                                                 '{0}_ico.jpg'.format(
                                                                     self.file_info.file_main_name))
            }
        ]
    ...
    def get_metadata_bus_configuration_list(self) -> list:
        ...
        return [
            ...
            },
            {
                ...
                self.Name_XPath: '/sensor_corrected_metadata/productInfo/RollViewingAngle'
            },
            {
