...
class CSatFilePlugins_zy1e_ahsi(CSatFilePlugins_zy1e):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'ZY1E_AHSI'
        information[self.Plugins_Info_Type_Title] = '资源一号E星AHSI传感器'
        return information
        ...
        return [
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file('ZY1E_AHSI.*.jpg',
    ...
    def get_metadata_bus_configuration_list(self) -> list:
        ...
        return [
            ...
            },
            {
                ...
                self.Name_Value: '(?i)ZY1E_AHSI.*.jpg'
            },
            {
