...
class CSatFilePlugins_gf2_wfv(CSatFilePlugins_gf2):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'GF2_WFV'
        information[self.Plugins_Info_Type_Title] = '高分二号WFV传感器'
        return information
    ...
    def get_classified_character_of_sat(self, sat_file_status):
        ...
        if (sat_file_status == self.Sat_Object_Status_Zip) or (sat_file_status == self.Sat_Object_Status_Dir):
            return r'(?i)^gf2_wfv.*[_].*', self.TextMatchType_Regex
        else:
            return r'(?i)^gf2_wfv.*[_].*[.]tiff$', self.TextMatchType_Regex
    ...
    def init_qa_file_list(self, parser: CMetaDataParser) -> list:
        ...
        return [
            {
                self.Name_FileName: self.get_fuzzy_metadata_file(r'(?i)^gf2_wfv.*[_].*[.]tiff$',
