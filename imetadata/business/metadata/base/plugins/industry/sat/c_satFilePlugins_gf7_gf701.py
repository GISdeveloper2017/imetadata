...
class CSatFilePlugins_gf7_gf701(CSatFilePlugins_gf7):
    ...
    def get_metadata_bus_filename_by_file(self) -> str:
        ...
        return CFile.join_file(
            ...
            self.get_fuzzy_metadata_file('GF701.*_.*_.*_[0-9]{10}.xml', '{0}.xml'.format(self.classified_object_name())
                                         )
        )
        ...
        return [
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file('GF701.*_.*_.*_pre.jpg',
                                                                 '{0}_pre.jpg'.format(self.file_info.file_main_name))
            },
            {
                self.Name_ID: self.View_MetaData_Type_Thumb,
                self.Name_FileName: self.get_fuzzy_metadata_file('GF701.*_.*_.*_ico.jpg',
                                                                 '{0}_ico.jpg'.format(
    ...
    def get_metadata_bus_configuration_list(self) -> list:
        ...
        return [
            ...
            },
            {
                ...
                self.Name_Value: CUtils.dict_value_by_name(self.get_information(), self.Plugins_Info_CopyRight,
                                                           None)
            },
            {
            ...
            },
            {
                ...
                self.Name_Value: CUtils.dict_value_by_name(self.get_information(), self.Plugins_Info_ProductType,
                                                           None)
            },
            {
