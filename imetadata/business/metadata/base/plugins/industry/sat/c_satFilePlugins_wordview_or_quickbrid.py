...
class CSatFilePlugins_wordview_or_quickbrid(COpticalSatPlugins):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'WordView_or_Quickbird'
        information[self.Plugins_Info_Type_Title] = 'WordView星或Quickbird星'
        information[self.Plugins_Info_Group] = 'WordView_or_Quickbird'
        information[self.Plugins_Info_Group_Title] = 'WordView_or_Quickbird'
    ...
    def get_metadata_bus_configuration_list(self) -> list:
        ...
        return [
            ...
            },
            {
                ...
                self.Name_Value: '(?i).*[-]M[0-9][A-Z]S.*.XML'
            }
        ]
    ...
    def metadata_bus_dict_process_custom(self, metadata_bus_dict):
        ...
        if not CUtils.equal_ignore_case(satelliteid, ''):
            if ('qb' in satelliteid) or ('QB' in satelliteid):
                ...
                metadata_bus_dict['sensorid'] = 'WV_PMS'
