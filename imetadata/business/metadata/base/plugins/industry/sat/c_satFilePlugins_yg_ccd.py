...
class CSatFilePlugins_yg_ccd(COpticalSatPlugins):

    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = 'YG_CCD'
        information[self.Plugins_Info_Type_Title] = 'YG星CCD传感器'
        information[self.Plugins_Info_Group] = 'YG'
        information[self.Plugins_Info_Group_Title] = '遥感卫星'
        information[self.Plugins_Info_CopyRight] = '中国遥感系列卫星'
        return information
        ...
        return [
            {
                ...
                self.Name_FileName: self.get_fuzzy_metadata_file(
                    r'(?i)YG.*_MSS.*(?!.*.thumb).*.jpg',
                    '{0}.thumb.jpg'.format(self.classified_object_name().replace('CCD', 'MSS')), True
                ),
            },
            {
        ...
        return [
            {
                ...
                self.Name_XPath: '/ProductMeta/StartTime',
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMeta/EndTime',
                self.Name_Format: self.MetaDataFormat_XML
            }
        ]
        ...
        return [
            {
                ...
                self.Name_XPath: '/ProductMeta/Satellite'
            },
            {
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMeta/Corners/UpperLeft/Latitude'
            },
            {
                self.Name_ID: 'topleftlongitude',  # 左上角经度 必填
                self.Name_XPath: '/ProductMeta/Corners/UpperLeft/Longitude'
            },
            {
                self.Name_ID: 'toprightlatitude',  # 右上角维度 必填
                self.Name_XPath: '/ProductMeta/Corners/UpperRight/Latitude'
            },
            {
                self.Name_ID: 'toprightlongitude',  # 右上角经度 必填
                self.Name_XPath: '/ProductMeta/Corners/UpperRight/Longitude'
            },
            {
                self.Name_ID: 'bottomrightlatitude',  # 右下角维度 必填
                self.Name_XPath: '/ProductMeta/Corners/LowerRight/Latitude'
            },
            {
                self.Name_ID: 'bottomrightlongitude',  # 右下角经度 必填
                self.Name_XPath: '/ProductMeta/Corners/LowerRight/Longitude'
            },
            {
                self.Name_ID: 'bottomleftlatitude',  # 左下角维度 必填
                self.Name_XPath: '/ProductMeta/Corners/LowerLeft/Latitude'
            },
            {
                self.Name_ID: 'bottomleftlongitude',  # 左下角经度 必填
                self.Name_XPath: '/ProductMeta/Corners/LowerLeft/Longitude'
            },
            {
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMeta/ViewingAngle'
            },
            {
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMeta/SceneID'
            },
            {
            ...
            },
            {
                ...
                self.Name_XPath: '/ProductMeta/CorrectionLevel'
            },
            {
            ...
            },
            {
                ...
                self.Name_Value: '(?i)YG.*_MSS.*.meta.xml'
            }
        ]
