...
class CSatFilePlugins_gf1_B_C_D(CSatPlugins):
    ...
    def get_classified_character_of_sat(self, sat_file_status):
        ...
        if (sat_file_status == self.Sat_Object_Status_Zip) or (sat_file_status == self.Sat_Object_Status_Dir):
            return 'gf1[A-Z]_pms_*_l1a*', self.TextMatchType_Common
        else:
            return 'gf1[A-Z]_pms_*_l1a*-pan.tiff', self.TextMatchType_Common
