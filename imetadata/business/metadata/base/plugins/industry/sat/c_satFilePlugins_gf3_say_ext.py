...
# @Author : 张源博
# @File : c_satFilePlugins_gf3_say_ext.py
...
class CSatFilePlugins_gf3_say_ext(CSatPlugins):
    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Title] = 'gf3_say_ext'
        information[self.Plugins_Info_Name] = 'gf3_say_ext'
        information[self.Plugins_Info_Code] = 'gf3'
        information[self.Plugins_Info_Catalog] = '高分三号'
    ...
    def get_classified_character_of_sat(self, sat_file_status):
        ...
        if (sat_file_status == self.Sat_Object_Status_Zip) or (sat_file_status == self.Sat_Object_Status_Dir):
            return 'gf3_say_ext_*_l1a*_l1*', self.TextMatchType_Common
        else:
            # GF3_SAY_EXT_000230_E118.8_N38.7_20160825_L1A_HH_L10002015644.tiff
            # 暂定gf3_say_ext_*_l1a_hh_l1*.tiff为主对象文件
            return 'gf3_say_ext_*_l1a_hh_l1*.tiff', self.TextMatchType_Common
    ...
    def get_classified_object_name_of_sat(self, sat_file_status) -> str:
        ...
        if sat_file_status == self.Sat_Object_Status_Zip:
            ...
            return self.file_info.file_main_name.replace('HH', 'HHHV')
    ...
    def init_qa_file_list(self, parser: CMetaDataParser) -> list:
        ...
        return [
            {
                self.Name_FileName: '{0}.tiff'.format(self.classified_object_name().replace('HHHV', 'HH')),
    ...
    def parser_metadata_view_list(self, parser: CMetaDataParser):
        ...
        return [
            ...
            },
            {
                ...
                self.Name_FileName: '{0}.thumb.jpg'.format(self.classified_object_name().replace('_HHHV_', '_HH_'))
            }
        ]