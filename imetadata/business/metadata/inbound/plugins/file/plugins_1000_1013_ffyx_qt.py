...
class plugins_1000_1013_ffyx_qt(plugins_1000_1002_ffyx_tj2000):
    ...
    def get_information(self) -> dict:
        ...
        information[self.Plugins_Info_Module_Distribute_Engine] = 'distribution_tjch_ffyx_qt'
    ...
    def get_classified_character_of_affiliated_keyword(self):
        ...
        return [
            ...
            },
            {
                ...
                self.Name_RegularExpression: '(?i)^' + self.file_info.file_main_name[:-1] + r'.\.tif[f]?'
            }
        ]
