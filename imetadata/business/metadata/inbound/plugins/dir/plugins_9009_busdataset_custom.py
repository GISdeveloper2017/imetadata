...
# @Author : 赵宇飞
# @File : plugins_9009_busdataset_custom.py
from imetadata.business.metadata.base.parser.metadata.c_metaDataParser import CMetaDataParser
from imetadata.business.metadata.base.plugins.c_21ATBusDataSetPlugins import C21ATBusDataSetPlugins


class plugins_9009_busdataset_custom(C21ATBusDataSetPlugins):
    def get_information(self) -> dict:
        information = super().get_information()
        information[self.Plugins_Info_Type] = '自定义影像'
        information[self.Plugins_Info_Type_Title] = '自定义影像数据集'
