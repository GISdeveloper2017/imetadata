...
class plugins_1000_0004_ffdem(CDirPlugins_keyword):
    def get_information(self) -> dict:
        ...
        information[self.Plugins_Info_Type] = '分幅DEM'
        information[self.Plugins_Info_Type_Title] = '分幅DEM'
        ...
        return [
            {
                ...
                self.Name_RegularExpression: '(?i)分幅DEM'
            },
            {
