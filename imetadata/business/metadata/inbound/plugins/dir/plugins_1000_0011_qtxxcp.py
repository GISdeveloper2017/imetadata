...
class plugins_1000_0011_qtxxcp(CDirPlugins_keyword):
    def get_information(self) -> dict:
        ...
        information[self.Plugins_Info_Type] = '其他信息产品'
        information[self.Plugins_Info_Type_Title] = '其他信息产品'
        ...
        return [
            {
                ...
                self.Name_RegularExpression: '(?i)其他信息产品成果'
            },
            {
