...
class plugins_1000_0006_dom(CDirPlugins_keyword):
    def get_information(self) -> dict:
        ...
        information[self.Plugins_Info_Type] = '参考DOM'
        information[self.Plugins_Info_Type_Title] = '参考DOM'
        ...
        return [
            {
                ...
                self.Name_RegularExpression: '(?i)DOM'
            },
            {
