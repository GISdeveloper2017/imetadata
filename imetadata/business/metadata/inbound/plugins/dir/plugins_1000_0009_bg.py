...
class plugins_1000_0009_bg(CDirPlugins_keyword):
    def get_information(self) -> dict:
        ...
        information[self.Plugins_Info_Type] = '报告'
        information[self.Plugins_Info_Type_Title] = '报告'
        ...
        return [
            {
                ...
                self.Name_RegularExpression: '(?i)报告'
            },
            {
