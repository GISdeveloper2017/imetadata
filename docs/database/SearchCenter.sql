...
-- 查询方法：
select 
  dm_index_ptd.diDescription, dm_index_ptd_files.diFileName, dm_index_ptd.diMemo, dm_index_ptd_files.diFileSize, 
  dm_index_ptd_files.diFileDate, dm_index_ptd_files.diIsSpatial, dm_index_ptd_files.diSpatialMetaData, 
  dm_index_ptd.diDeptID, dm_index_ptd.diAudited, dm_index_ptd.diImportTime, dm_index_ptd.diClass, dm_index_ptd.diType, ro_file.fid
from dm_index_ptd 
...
select daSearch from da_search_package 
