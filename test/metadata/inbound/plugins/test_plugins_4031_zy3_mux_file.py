...
from imetadata.business.metadata.inbound.plugins.file.plugins_4031_zy3_mux import plugins_4031_zy3_mux
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源一号01星MUX传感器压缩包文件")  # 模块标题
class Test_plugins_4031_zy3_mux_file(Plugins_Test_Base):
