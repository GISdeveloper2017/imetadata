...
from imetadata.business.metadata.inbound.plugins.file.plugins_1000_1010_xqyx_sy_tj2000 import  \
    plugins_1000_1010_xqyx_sy_tj2000
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("天津测绘镶嵌影像成果市域镶嵌2000天津城市坐标系")  # 模块标题
class Test_plugins_1000_1010_xqyx_sy_tj2000(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_1000_1010_xqyx_sy_tj2000(file_info)
