...
from imetadata.business.metadata.inbound.plugins.dir.plugins_1000_0011_bg import plugins_1000_0011_bg
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("天津测绘报告")  # 模块标题
class Test_plugins_1000_0011_bg(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_1000_0011_bg(file_info)
