...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4004_gf1_d import plugins_4004_gf1_d
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("GF1_D文件夹类型成果影像")  # 模块标题
class Test_plugins_4004_gf1_d_dir(Plugins_Test_Base):
