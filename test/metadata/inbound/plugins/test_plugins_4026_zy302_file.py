...
from imetadata.business.metadata.inbound.plugins.file.plugins_4026_zy3_zy302 import plugins_4026_zy3_zy302
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源一号01星压缩包文件")  # 模块标题
class Test_plugins_4026_zy3_zy302_file(Plugins_Test_Base):
