...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4029_zy1e_ahsi import plugins_4029_zy1e_ahsi
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源一号E星AHSI传感器目录文件")  # 模块标题
class Test_plugins_4029_zy1e_ahsi_dir(Plugins_Test_Base):
