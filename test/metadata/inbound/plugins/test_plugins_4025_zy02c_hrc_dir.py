...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4025_zy02c_hrc import plugins_4025_zy02c_hrc
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源三号02星HRC传感器目录文件")  # 模块标题
class Test_plugins_4025_zy02c_hrc_dir(Plugins_Test_Base):
