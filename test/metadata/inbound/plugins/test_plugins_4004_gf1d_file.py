...
from imetadata.business.metadata.inbound.plugins.file.plugins_4004_gf1d import plugins_4004_gf1d
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("GF1D压缩包类型成果影像")  # 模块标题
class Test_plugins_4004_gf1d_file(Plugins_Test_Base):
