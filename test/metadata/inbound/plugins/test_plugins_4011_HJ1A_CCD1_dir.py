...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4011_HJ1A_CCD1 import plugins_4011_HJ1A_CCD1
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("环境一号A星CCD1传感器目录文件")  # 模块标题
class Test_plugins_4011_HJ1A_CCD1_dir(Plugins_Test_Base):
