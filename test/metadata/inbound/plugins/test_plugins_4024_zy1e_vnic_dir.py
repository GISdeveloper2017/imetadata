...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4024_zy1e_vnic import plugins_4024_zy1e_vnic
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源一号E星VNIC传感器目录文件")  # 模块标题
class Test_plugins_4024_zy1e_vnic_dir(Plugins_Test_Base):
