...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4029_kompsat2 import plugins_4029_kompsat2
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("kompsat2目录文件")  # 模块标题
class Test_plugins_4029_kompsat2_dir(Plugins_Test_Base):
