...
from imetadata.business.metadata.inbound.plugins.dir.plugins_1000_0001_ksjmcg import plugins_1000_0001_ksjmcg
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("天津测绘空三加密成果")  # 模块标题
class Test_plugins_1000_0001_ksjmcg(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_1000_0001_ksjmcg(file_info)
    ...
    def test_file_info_list(self):
        return [

            {
                ...
                self.Name_Test_file_path: '202008{0}空三加密成果及加密使用原始卫星影像'.format(CFile.sep()),
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
                self.Name_Test_object_name: '空三加密成果及加密使用原始卫星影像'
            }
        ]
