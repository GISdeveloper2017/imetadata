...
from imetadata.business.metadata.inbound.plugins.file.plugins_4034_hy1_scal1 import plugins_4034_hy1_scal1
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("海洋一号scal1压缩包文件")  # 模块标题
class Test_plugins_4034_hy1_scal1_file(Plugins_Test_Base):
