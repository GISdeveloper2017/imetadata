...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4036_radarsat import plugins_4036_radarsat
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("radarsat星目录文件")  # 模块标题
class Test_plugins_4036_radarsat_dir(Plugins_Test_Base):
