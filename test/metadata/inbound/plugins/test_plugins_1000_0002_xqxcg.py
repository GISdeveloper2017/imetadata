...
from imetadata.business.metadata.inbound.plugins.dir.plugins_1000_0002_xqxcg import plugins_1000_0002_xqxcg
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("天津测绘镶嵌线成果")  # 模块标题
class Test_plugins_1000_0002_xqxcg(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_1000_0002_xqxcg(file_info)
    ...
    def test_file_info_list(self):
        return [

            {
                ...
                self.Name_Test_file_path: '202008{0}镶嵌线成果'.format(CFile.sep()),
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
                self.Name_Test_object_name: '镶嵌线成果'
            }
        ]
