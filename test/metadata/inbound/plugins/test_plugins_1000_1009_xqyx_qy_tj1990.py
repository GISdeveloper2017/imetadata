...
from imetadata.business.metadata.inbound.plugins.file.plugins_1000_1009_xqyx_qy_tj1990 import \
    plugins_1000_1009_xqyx_qy_tj1990
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("天津测绘镶嵌影像成果区域镶嵌1990天津任意直角坐标系")  # 模块标题
class Test_plugins_1000_1009_xqyx_qy_tj1990(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_1000_1009_xqyx_qy_tj1990(file_info)
