...
from imetadata.business.metadata.inbound.plugins.file.plugins_4001_triplesat_pms import plugins_4001_triplesat_pms
        ...
        return [
            {
                ...
                self.Name_Test_file_path: 'TRIPLESAT_1_PMS_20190111022824_001F3FVI_016.zip',
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
                self.Name_Test_object_name: 'TRIPLESAT_1_PMS_20190111022824_001F3FVI_016'
            },
            {
                self.Name_Test_File_Type: self.FileType_File,
                self.Name_Test_file_path: 'TRIPLESAT_2_PMS_20191125021402_002047VI_021.zip',
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
                self.Name_Test_object_name: 'TRIPLESAT_2_PMS_20191125021402_002047VI_021'
            },
            {
                self.Name_Test_File_Type: self.FileType_File,
                self.Name_Test_file_path: 'TRIPLESAT_3_PMS_20190108021412_001E18VI_007.zip',
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
                self.Name_Test_object_name: 'TRIPLESAT_3_PMS_20190108021412_001E18VI_007'
            },
            {
                self.Name_Test_File_Type: self.FileType_File,
                self.Name_Test_file_path: 'TRIPLESAT_4_PMS_20191111021739_0007C9VI_032.zip',
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
