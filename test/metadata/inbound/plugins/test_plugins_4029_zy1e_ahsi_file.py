...
from imetadata.business.metadata.inbound.plugins.file.plugins_4029_zy1e_ahsi import plugins_4029_zy1e_ahsi
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源一号E星AHSI传感器压缩包文件")  # 模块标题
class Test_plugins_4029_zy1e_ahsi_file(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_4029_zy1e_ahsi(file_info)
