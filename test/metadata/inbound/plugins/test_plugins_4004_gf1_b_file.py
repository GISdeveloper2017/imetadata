...
from imetadata.business.metadata.inbound.plugins.file.plugins_4004_gf1_b import plugins_4004_gf1_b
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("GF1_B压缩包类型成果影像")  # 模块标题
class Test_plugins_4004_gf1_b_file(Plugins_Test_Base):
