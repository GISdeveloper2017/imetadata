...
from imetadata.business.metadata.inbound.plugins.file.plugins_4004_gf1_c import plugins_4004_gf1_c
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("GF1_C压缩包类型成果影像")  # 模块标题
class Test_plugins_4004_gf1_c_file(Plugins_Test_Base):
