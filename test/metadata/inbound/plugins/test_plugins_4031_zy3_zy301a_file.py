...
from imetadata.business.metadata.inbound.plugins.file.plugins_4031_zy3_zy301a import plugins_4031_zy3_zy301a
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("资源一号01星压缩包文件")  # 模块标题
class Test_plugins_4031_zy3_zy301a_file(Plugins_Test_Base):
