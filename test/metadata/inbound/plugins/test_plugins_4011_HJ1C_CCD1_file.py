...
from imetadata.business.metadata.inbound.plugins.file.plugins_4011_HJ1C_CCD1 import plugins_4011_HJ1C_CCD1
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("环境一号C星CCD1传感器压缩包文件")  # 模块标题
class Test_plugins_4011_HJ1C_CCD1_file(Plugins_Test_Base):
