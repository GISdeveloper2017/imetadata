...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4014_landsat8 import plugins_4014_landsat8
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("landsat8目录文件")  # 模块标题
class Test_plugins_4014_landsat8_dir(Plugins_Test_Base):
