...
from imetadata.business.metadata.inbound.plugins.dir.plugins_1000_0005_xqdem import plugins_1000_0005_xqdem
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("天津测绘镶嵌DEM")  # 模块标题
class Test_plugins_1000_0005_xqdem(Plugins_Test_Base):
    def create_plugins(self, file_info: CDMFilePathInfoEx = None) -> CPlugins:
        return plugins_1000_0005_xqdem(file_info)
    ...
    def test_file_info_list(self):
        return [

            {
                ...
                self.Name_Test_file_path: '202008{0}镶嵌DEM'.format(CFile.sep()),
                self.Name_Test_object_confirm: self.Object_Confirm_IKnown,
                self.Name_Test_object_name: '镶嵌DEM'
            }
        ]
