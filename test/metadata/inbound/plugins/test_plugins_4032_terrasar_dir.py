...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4032_terrasar import plugins_4032_terrasar
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("terrasar星目录文件")  # 模块标题
class Test_plugins_4032_terrasar_dir(Plugins_Test_Base):
