...
from imetadata.business.metadata.inbound.plugins.file.plugins_4035_terrasar import plugins_4035_terrasar
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("terrasar星压缩包文件")  # 模块标题
class Test_plugins_4035_terrasar_file(Plugins_Test_Base):
