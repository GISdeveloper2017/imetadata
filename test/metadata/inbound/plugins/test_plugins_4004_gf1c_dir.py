...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4004_gf1c import plugins_4004_gf1c
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("GF1C文件夹类型成果影像")  # 模块标题
class Test_plugins_4004_gf1c_dir(Plugins_Test_Base):
