...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4007_gf4_pms import plugins_4007_gf4_pms
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("高分四号PMS传感器目录文件")  # 模块标题
        ...
        return [
            {
                ...
                self.Name_Test_file_path: 'GF4_PMS_E72.9_N28.9_20170211_L1A0000155286',
