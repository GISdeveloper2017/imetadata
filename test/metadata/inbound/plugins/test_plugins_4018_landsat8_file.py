...
from imetadata.business.metadata.inbound.plugins.file.plugins_4018_landsat8 import plugins_4018_landsat8
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("landsat8压缩包文件")  # 模块标题
class Test_plugins_4018_landsat8_file(Plugins_Test_Base):
