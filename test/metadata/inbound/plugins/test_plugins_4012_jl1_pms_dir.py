...
from imetadata.business.metadata.inbound.plugins.dir.plugins_4012_jl1_pms import plugins_4012_jl1_pms
from test.metadata.inbound.plugins.plugins_test_base import Plugins_Test_Base


@allure.feature("吉林一号PMS传感器目录文件")  # 模块标题
class Test_plugins_4012_jl1_pms_dir(Plugins_Test_Base):
